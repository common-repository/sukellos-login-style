<?php
/**
 * Plugin Name: Sukellos - Login Style
 * Plugin URI: https://wp-adminbuilder.com/login-style/
 * Description: Sukellos Framework Tools - Login Style
 * Version: 1.1.8
 ...
 *
 *
 * @package   WP-Sukellos-Login-Style
 * @author    Sukellos
 * @category  Admin
...
// Sukellos Framework
use Sukellos\Admin\WP_Sukellos_Login_Style_Admin;
 ...
 * @since 1.0.0
 */
final class WP_Sukellos_Login_Style_Loader extends WP_Sukellos_Fw_Loader {
    ...
    public function get_plugin() {
        ...
        return WP_Sukellos_Login_Style::instance();
    }
    ...
    public function get_plugin_admin() {
        ...
        return WP_Sukellos_Login_Style_Admin::instance();
    }
}
WP_Sukellos_Login_Style_Loader::instance();